...
<html lang="en">
  <head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="../dist/css/mainPageStyle.css" type="text/css">
  ...
  <body>
    ...
    <div class="wrapper-navbar">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          ...
          <a class="navbar-brand pl-5" href="/home">PARAGA SCOUT</a>
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown  mr-4">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="/pengurus">Struktur Organisasi</a>
    ...
    <div class="wrapper-artikel mt-5">
       <div class="container">
         <div class="title">
           <h1 class="mb-5">Sejarah Kemerdekaan Indonesia</h1>
            <div class="detail-artikel">
              <ul>
                <li class="penulis">Reinhart</li>
