            ...
            <div class="row mt-4">
                <div class="col-xl">
                    <div class="card mb-4">
                        ...
                        {{-- Form Input Artikel --}}
                        <form class="px-4" method="post" action="/admin/artikel" enctype="multipart/form-data">
                            @csrf
                            <div class="mt-3 mb-3">
                                <label for="judul_artikel" class="form-label">Judul Artikel</label>
                                <input type="text" class="form-control @error('judul_artikel') is-invalid @enderror" id="judul_artikel" name="judul_artikel" required autofocus value="{{old('judul_artikel')}}">
                                @error('judul_artikel')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('penulis_artikel') is-invalid @enderror" id="penulis_artikel" name="penulis_artikel" required autofocus value="{{old('penulis_artikel')}}"></input>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control datepicker @error('waktu_dibuat_artikel') is-invalid @enderror" id="waktu_dibuat_artikel" name="waktu_dibuat_artikel" required autofocus></input>
                            </div>  
                            <div class="mb-3">
