...
<html lang="en">
    <head>
        ...
        <link href="{{URL::asset('/dist/css/diagram.css') }}" rel="stylesheet" />
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Paraga Scout</a>
            <!-- Sidebar Toggle-->
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Paraaga Scout 2021</div>
                            <div>
        ...
        <script src="{{ URL::asset('/dist/js/diagram.js') }}"></script>
    </body>
</html>
